...
const BottomNav = () => {
  ...
  return (
    <div className="md:hidden fixed bottom-0 left-0 right-0 bg-white/80 backdrop-blur-lg border-t border-gray-100 z-50 pb-safe shadow-[0_-8px_30px_rgba(0,0,0,0.04)]">
